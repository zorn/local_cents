...
config :local_cents, LocalCentsWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: LocalCentsWeb.ErrorHTML, json: LocalCentsWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: LocalCents.PubSub,
  live_view: [signing_salt: "lORt+a6s"]
...
config :local_cents, LocalCents.Mailer, adapter: Swoosh.Adapters.Local
