    ...
    %{
      ...
      checks: %{
        enabled: [
          ...
          # We serve no file downloads, so this fires on nothing today. It is a
          # cheap guardrail: when a download is added, it steers the code toward
          # `send_download/3` — which sanitizes the filename — over a hand-rolled
