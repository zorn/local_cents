      ...
      <div class={[
              ...
              <button
                ...
                class={[
                  ...
                  if(@active_style == style_key,
                    do: if(@active_style == "dark", do: "bg-white/20 text-white shadow-sm", else: "bg-white text-gray-900 shadow-sm"),
                    else: if(@active_style == "dark", do: "text-gray-500 hover:text-gray-300", else: "text-gray-600 hover:text-gray-900")
                  )
                ]}
              >
                {style_label}
        ...
        <div class="space-y-8">
          <%= cond do %>
            ...
            <% @active_style == "simple" -> %>
              <%!-- Library Window --%>
              <div id="simple-library-window" class="bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden">
              ...
              <div id="simple-document-window" class="relative bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden">
                <div class="relative flex items-center pl-3 pr-4 py-2 bg-gray-100 border-b border-gray-200 select-none">
                  <div class="flex items-center gap-2 z-10">
                    <button class="w-3 h-3 rounded-full bg-[#FF5F57] hover:brightness-90 transition-all border border-black/10 shadow-sm"></button>
                    <button class="w-3 h-3 rounded-full bg-[#FEBC2E] hover:brightness-90 transition-all border border-black/10 shadow-sm"></button>
                ...
                <div class="mx-4 mb-4 border border-gray-200 rounded-lg overflow-hidden">
                  <div class="px-3 py-2.5 border-b border-gray-200 bg-gray-50">
                    <%= if @show_new_expense do %>
                      <div class="flex items-center gap-2">
                        <input id="new-expense-input" type="text" autofocus
                        ...
                        <button id="new-expense-toggle-btn" phx-click="toggle_new_expense"
                      ...
                      <p class="mt-1.5 text-xs text-gray-400 pl-0.5">Type a phrase like "coffee 4.75" or "netflix 22.99 yesterday"</p>
                    <% else %>
                      <div class="flex items-center gap-2">
                        <div class="relative">
                          ...
                          <input id="expense-search-input" type="text" placeholder="search"
                        ...
                        <button id="expense-new-btn" phx-click="toggle_new_expense"
                          class="flex-shrink-0 px-3 py-1.5 text-sm border border-gray-400 rounded bg-white hover:bg-gray-100 text-gray-700 font-medium transition-colors">
                          New Expense
                        </button>
                      </div>
                  ...
                  <%= for expense <- @expenses do %>
                    <div id={"expense-row-#{expense.id}"} phx-click="select_expense" phx-value-id={expense.id}
                      class="flex items-center gap-4 px-4 py-3.5 border-b border-gray-100 hover:bg-gray-50 transition-colors cursor-pointer">
                      <span class="flex-shrink-0 text-sm text-gray-500 tabular-nums w-24">{expense.date}</span>
                      <span class="flex-1 text-sm font-medium text-gray-900">{expense.description}</span>
                      <div class="flex items-center gap-1.5">
                        <%= for tag <- expense.tags do %>
                          <span class={["px-2.5 py-0.5 text-xs font-medium rounded-full", tag.class]}>{tag.label}</span>
                        <% end %>
                      </div>
                      <span class="flex-shrink-0 text-sm font-semibold text-gray-800 tabular-nums w-16 text-right">{expense.amount}</span>
                    </div>
                  <% end %>
                    ...
                    <div class="w-80 bg-gray-50 border-l border-gray-200 flex flex-col shadow-xl">
                      ...
                      <div class="px-6 pt-2 pb-4 flex-1 space-y-5 overflow-y-auto">
                        <div>
                          ...
                          <input type="date" value={to_date_input(@selected_expense.date)}
                        ...
                        <div>
                          ...
                          <input type="text" value={@selected_expense.description}
                            class="w-full px-3 py-2 text-sm border border-gray-300 rounded-md bg-white focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent" />
                        </div>
                        <div>
                          <label class="block text-sm font-bold text-gray-900 mb-1.5">Cost</label>
                          <input type="text" value={@selected_expense.amount}
                            class="w-full px-3 py-2 text-sm border border-gray-300 rounded-md bg-white focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent" />
                        </div>
                        <div>
                          ...
                          <div class="space-y-2.5">
                            <%= for tag <- @available_tags do %>
                              <label class="flex items-center gap-3 cursor-pointer">
                                <input type="checkbox" checked={Enum.any?(@selected_expense.tags, &(&1.label == tag.label))}
                      ...
                      <div class="flex items-center justify-between px-6 py-4 border-t border-gray-200 bg-gray-50">
                        <button class="text-sm font-medium text-red-500 hover:text-red-700 transition-colors">Delete</button>
                        <button class="px-5 py-2 text-sm font-semibold text-white bg-blue-600 hover:bg-blue-700 rounded-md transition-colors shadow-sm">Save</button>
                      </div>
                    </div>
                  </div>
                <% end %>
            ...
            <% @active_style == "warm" -> %>
              <%!-- Warm Library Window --%>
              <div id="warm-library-window" class="bg-[#F6F1E8] rounded-xl shadow-lg border border-[#C5B89A] overflow-hidden">
                  ...
                  <div class="overflow-y-auto" style="min-height: 220px; max-height: 320px;">
                    <%= for book <- @books do %>
                      <div class="flex items-center gap-4 px-4 py-4 bg-[#FAF7F0] border-b border-[#DDD5C5] hover:bg-[#F0E8DB] transition-colors">
                        <div class="flex-1 min-w-0">
                          <p class="text-base font-semibold text-[#2A1F14] leading-snug">{book.name}</p>
                          <p class="text-xs text-[#8C7557] mt-0.5">Last Updated: {book.last_updated}</p>
                        </div>
              ...
              <div id="warm-document-window" class="relative bg-[#F6F1E8] rounded-xl shadow-lg border border-[#C5B89A] overflow-hidden">
                <div class="relative flex items-center pl-3 pr-4 py-2 bg-[#EBE4D8] border-b border-[#C5B89A] select-none">
                  <div class="flex items-center gap-2 z-10">
                    <button class="w-3 h-3 rounded-full bg-[#FF5F57] border border-black/10"></button>
                    <button class="w-3 h-3 rounded-full bg-[#FEBC2E] border border-black/10"></button>
                ...
                <div class="m-4 bg-[#E8E1D3] rounded-lg border border-[#C5B89A] px-6 py-5">
                  <p class="text-xs font-bold uppercase tracking-widest text-[#8C7557] mb-4">Spending by Category</p>
                  <div class="space-y-3">
                ...
                <div class="mx-4 mb-4 border border-[#C5B89A] rounded-lg overflow-hidden">
                  <div class="px-3 py-2.5 border-b border-[#C5B89A] bg-[#EEE8DA]">
                    <%= if @show_new_expense do %>
                      <div class="flex items-center gap-2">
                        <input id="warm-new-expense-input" type="text" autofocus
                        ...
                        <button id="warm-new-expense-toggle-btn" phx-click="toggle_new_expense"
                      ...
                      <p class="mt-1.5 text-xs text-[#8C7557] pl-0.5">Type a phrase like "coffee 4.75" or "netflix 22.99 yesterday"</p>
                    <% else %>
                      <div class="flex items-center gap-2">
                        <div class="relative">
                          <div class="absolute inset-y-0 left-2.5 flex items-center pointer-events-none">
                          ...
                          <input id="warm-expense-search-input" type="text" placeholder="search"
                        ...
                        <div class="flex-1"></div>
                        <button id="warm-expense-new-btn" phx-click="toggle_new_expense"
                  ...
                  <%= for expense <- @expenses do %>
                    <div id={"warm-expense-row-#{expense.id}"} phx-click="select_expense" phx-value-id={expense.id}
                      class="flex items-center gap-4 px-4 py-3.5 border-b border-[#E4DBD0] hover:bg-[#F0E8DB] transition-colors cursor-pointer">
                      <span class="flex-shrink-0 text-sm text-[#8C7557] tabular-nums w-24">{expense.date}</span>
                      <span class="flex-1 text-sm font-medium text-[#2A1F14]">{expense.description}</span>
                      <div class="flex items-center gap-1.5">
                        <%= for tag <- expense.tags do %>
                          <span class={["px-2.5 py-0.5 text-xs font-medium rounded-full", tag_class("warm", tag.label)]}>{tag.label}</span>
                        <% end %>
                      </div>
                      <span class="flex-shrink-0 text-sm font-semibold text-[#C4622D] tabular-nums w-16 text-right">{expense.amount}</span>
                    </div>
                  <% end %>
                ...
                <%= if @selected_expense do %>
                  <div id="warm-expense-edit-panel" class="absolute inset-0 flex">
                    ...
                    <div class="w-80 bg-[#EBE4D8] border-l border-[#C5B89A] flex flex-col shadow-xl">
                      ...
                      <div class="px-6 pt-2 pb-4 flex-1 space-y-5 overflow-y-auto">
                        <div>
                          <label class="block text-xs font-bold uppercase tracking-widest text-[#8C7557] mb-1.5">Date</label>
                          <input type="date" value={to_date_input(@selected_expense.date)}
                        ...
                        <div>
                          <label class="block text-xs font-bold uppercase tracking-widest text-[#8C7557] mb-1.5">Description</label>
                          <input type="text" value={@selected_expense.description}
                            class="w-full px-3 py-2 text-sm border border-[#C5B89A] rounded bg-[#FAF7F0] text-[#2A1F14] focus:outline-none focus:ring-2 focus:ring-[#C4622D]/40 focus:border-[#C4622D]" />
                        </div>
                        <div>
                          <label class="block text-xs font-bold uppercase tracking-widest text-[#8C7557] mb-1.5">Cost</label>
                          <input type="text" value={@selected_expense.amount}
                            class="w-full px-3 py-2 text-sm border border-[#C5B89A] rounded bg-[#FAF7F0] text-[#2A1F14] focus:outline-none focus:ring-2 focus:ring-[#C4622D]/40 focus:border-[#C4622D]" />
                        </div>
                        <div>
                          <label class="block text-xs font-bold uppercase tracking-widest text-[#8C7557] mb-2.5">Tags</label>
                          <div class="space-y-2.5">
                            <%= for tag <- @available_tags do %>
                              <label class="flex items-center gap-3 cursor-pointer">
                                <input type="checkbox" checked={Enum.any?(@selected_expense.tags, &(&1.label == tag.label))}
                      ...
                      <div class="flex items-center justify-between px-6 py-4 border-t border-[#C5B89A] bg-[#E5DDD0]">
                        <button class="text-sm font-medium text-red-700 hover:text-red-900 transition-colors">Delete</button>
                        <button class="px-5 py-2 text-sm font-semibold text-white bg-[#C4622D] hover:bg-[#A8501E] rounded transition-colors shadow-sm">Save</button>
                      </div>
                    </div>
                  </div>
                <% end %>
            ...
            <% @active_style == "dark" -> %>
              <%!-- Dark Library Window --%>
              <div id="dark-library-window" class="bg-[#161B22] rounded-2xl border border-[#30363D] overflow-hidden shadow-2xl shadow-black/50">
                  ...
                  <div class="overflow-y-auto" style="min-height: 220px; max-height: 320px;">
                    <%= for book <- @books do %>
                      <div class="flex items-center gap-4 px-4 py-4 border-b border-[#21262D] hover:bg-[#1C2130] transition-colors">
                        <div class="flex-1 min-w-0">
                          <p class="text-base font-semibold text-[#E6EDF3] leading-snug">{book.name}</p>
                          <p class="text-xs text-[#6E7681] mt-0.5">Last Updated: {book.last_updated}</p>
                        </div>
              ...
              <div id="dark-document-window" class="relative bg-[#161B22] rounded-2xl border border-[#30363D] overflow-hidden shadow-2xl shadow-black/50">
                <div class="relative flex items-center pl-3 pr-4 py-2 bg-[#0D1117] border-b border-[#30363D] select-none">
                  <div class="flex items-center gap-2 z-10">
                    <button class="w-3 h-3 rounded-full bg-[#FF5F57] border border-black/20"></button>
                    <button class="w-3 h-3 rounded-full bg-[#FEBC2E] border border-black/20"></button>
                ...
                <div class="m-4 bg-[#0D1117] rounded-lg border border-[#21262D] px-6 py-5">
                  <p class="text-xs font-mono uppercase tracking-widest text-[#6E7681] mb-4">Spending Overview</p>
                ...
                <div class="mx-4 mb-4 border border-[#30363D] rounded-lg overflow-hidden">
                  <div class="px-3 py-2.5 border-b border-[#30363D] bg-[#0D1117]">
                    <%= if @show_new_expense do %>
                      <div class="flex items-center gap-2">
                        <input id="dark-new-expense-input" type="text" autofocus
                        ...
                        <button id="dark-new-expense-toggle-btn" phx-click="toggle_new_expense"
                      ...
                      <p class="mt-1.5 text-xs text-[#6E7681] pl-0.5">Type a phrase like "coffee 4.75" or "netflix 22.99 yesterday"</p>
                    <% else %>
                      <div class="flex items-center gap-2">
                        <div class="relative">
                          <div class="absolute inset-y-0 left-2.5 flex items-center pointer-events-none">
                          ...
                          <input id="dark-expense-search-input" type="text" placeholder="search"
                        ...
                        <div class="flex-1"></div>
                        <button id="dark-expense-new-btn" phx-click="toggle_new_expense"
                  ...
                  <%= for expense <- @expenses do %>
                    <div id={"dark-expense-row-#{expense.id}"} phx-click="select_expense" phx-value-id={expense.id}
                      class="flex items-center gap-4 px-4 py-3.5 border-b border-[#21262D] hover:bg-[#1C2130] transition-colors cursor-pointer">
                      <span class="flex-shrink-0 text-sm text-[#6E7681] tabular-nums font-mono w-24">{expense.date}</span>
                      <span class="flex-1 text-sm font-medium text-[#E6EDF3]">{expense.description}</span>
                      <div class="flex items-center gap-1.5">
                        <%= for tag <- expense.tags do %>
                          <span class={["px-2.5 py-0.5 text-xs font-medium rounded-full", tag_class("dark", tag.label)]}>{tag.label}</span>
                        <% end %>
                      </div>
                      <span class="flex-shrink-0 text-sm font-semibold text-emerald-400 tabular-nums font-mono w-16 text-right">{expense.amount}</span>
                    </div>
                  <% end %>
                ...
                <%= if @selected_expense do %>
                  <div id="dark-expense-edit-panel" class="absolute inset-0 flex">
                    ...
                    <div class="w-80 bg-[#0D1117] border-l border-[#30363D] flex flex-col shadow-2xl">
                      ...
                      <div class="px-6 pt-2 pb-4 flex-1 space-y-5 overflow-y-auto">
                        <div>
                          <label class="block text-xs font-mono uppercase tracking-widest text-[#6E7681] mb-1.5">Date</label>
                          <input type="date" value={to_date_input(@selected_expense.date)}
                        ...
                        <div>
                          <label class="block text-xs font-mono uppercase tracking-widest text-[#6E7681] mb-1.5">Description</label>
                          <input type="text" value={@selected_expense.description}
                            class="w-full px-3 py-2 text-sm border border-[#444C56] rounded bg-[#161B22] text-[#E6EDF3] focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500" />
                        </div>
                        <div>
                          <label class="block text-xs font-mono uppercase tracking-widest text-[#6E7681] mb-1.5">Cost</label>
                          <input type="text" value={@selected_expense.amount}
                            class="w-full px-3 py-2 text-sm border border-[#444C56] rounded bg-[#161B22] text-[#E6EDF3] focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500" />
                        </div>
                        <div>
                          <label class="block text-xs font-mono uppercase tracking-widest text-[#6E7681] mb-2.5">Tags</label>
                          <div class="space-y-2.5">
                            <%= for tag <- @available_tags do %>
                              <label class="flex items-center gap-3 cursor-pointer">
                                <input type="checkbox" checked={Enum.any?(@selected_expense.tags, &(&1.label == tag.label))}
                      ...
                      <div class="flex items-center justify-between px-6 py-4 border-t border-[#30363D] bg-[#0D1117]">
                        <button class="text-sm font-medium text-red-400 hover:text-red-300 transition-colors">Delete</button>
                        <button class="px-5 py-2 text-sm font-semibold text-white bg-indigo-600 hover:bg-indigo-500 rounded transition-colors shadow-sm">Save</button>
                      </div>
                    </div>
                  </div>
                <% end %>
            ...
            <% @active_style == "notebook" -> %>
              ...
              <div id="notebook-library-window" class={["rounded-xl overflow-hidden border border-[#a8c0e0] shadow-lg shadow-[#3f7fd6]/20", "nb-tex-#{@notebook_texture}"]}>
                ...
                <div class="m-4 bg-white rounded overflow-hidden border border-[#c3d2f0] shadow-md shadow-[#3f7fd6]/20">
                  <div class="overflow-y-auto" style="min-height: 220px; max-height: 320px;">
                    <%= for book <- @books do %>
                      <div class="flex items-center gap-4 px-4 py-4 border-b border-[#c3d2f0]/60 hover:bg-[#3f7fd6]/5 transition-colors">
                        <div class="flex-1 min-w-0">
                          <p class="font-nunito text-base font-semibold text-[#22335c] leading-snug">{book.name}</p>
                          <p class="font-nunito text-xs text-[#6980b0] mt-0.5">Last Updated: {book.last_updated}</p>
                        </div>
                        <button class="font-nunito flex-shrink-0 px-3 py-1 text-sm border-2 border-[#3f7fd6] rounded-full text-[#3f7fd6] hover:bg-[#3f7fd6] hover:text-white font-bold transition-all">
                          Open
                        </button>
                      </div>
                    <% end %>
                ...
                <div class="flex items-center justify-between px-4 py-4">
                  <button class="font-nunito font-bold px-4 py-1.5 text-sm bg-[#3f7fd6] hover:bg-[#2d6bc4] text-white rounded-full transition-colors shadow-sm shadow-[#3f7fd6]/30">
                    + New Book
                  </button>
                  <button class="font-nunito w-7 h-7 rounded-full border-2 border-[#3f7fd6] flex items-center justify-center text-[#3f7fd6] hover:bg-[#3f7fd6]/10 text-sm font-bold transition-colors">
                    ?
                  </button>
                </div>
              </div>
              ...
              <div id="notebook-document-window" class="relative bg-white rounded-xl overflow-hidden border border-[#c3d2f0] shadow-lg shadow-[#3f7fd6]/15">
                <%!-- Denim title bar --%>
                <div class="nb-denim relative flex items-center pl-3 pr-4 py-2 select-none border-b border-[#0d1a35]">
                  <div class="flex items-center gap-2 z-10">
                    <button class="w-3 h-3 rounded-full bg-[#FF5F57] border border-black/20"></button>
                ...
                <div class="m-4 nb-graph rounded-lg border border-[#c3d2f0] px-6 py-5">
                  <p class="font-caveat text-lg text-[#3f7fd6] mb-4">where it all went →</p>
                  <div class="flex items-end gap-2 h-20 mb-3">
                    <div class="flex-1 flex flex-col justify-end items-center gap-1">
                      ...
                      <div class="w-full bg-[#3f7fd6]/70 rounded-t-sm" style="height: 75%"></div>
                      <span class="font-nunito text-[9px] font-bold uppercase tracking-wider text-[#22335c] mt-1">Food</span>
                    </div>
                    <div class="flex-1 flex flex-col justify-end items-center gap-1">
                      <span class="font-caveat text-sm text-[#22335c]">$135</span>
                      <div class="w-full bg-[#9b8bd6]/70 rounded-t-sm" style="height: 41%"></div>
                      <span class="font-nunito text-[9px] font-bold uppercase tracking-wider text-[#22335c] mt-1">Sports</span>
                    </div>
                    <div class="flex-1 flex flex-col justify-end items-center gap-1">
                      <span class="font-caveat text-sm text-[#22335c]">$67</span>
                      <div class="w-full bg-[#e0796e]/70 rounded-t-sm" style="height: 21%"></div>
                      <span class="font-nunito text-[9px] font-bold uppercase tracking-wider text-[#22335c] mt-1">Kids</span>
                    </div>
                    <div class="flex-1 flex flex-col justify-end items-center gap-1">
                      <span class="font-caveat text-sm text-[#22335c]">$68</span>
                      <div class="w-full bg-[#6fc59a]/70 rounded-t-sm" style="height: 22%"></div>
                      <span class="font-nunito text-[9px] font-bold uppercase tracking-wider text-[#22335c] mt-1">Dining</span>
                    </div>
                    <div class="flex-1 flex flex-col justify-end items-center gap-1">
                      <span class="font-caveat text-sm text-[#22335c]">$44</span>
                      <div class="w-full bg-[#e6b53c]/70 rounded-t-sm" style="height: 14%"></div>
                      <span class="font-nunito text-[9px] font-bold uppercase tracking-wider text-[#22335c] mt-1">Other</span>
                    </div>
                  </div>
                ...
                <div class="mx-4 mb-4 nb-ruled rounded-lg border border-[#c3d2f0] overflow-hidden">
                  ...
                  <div class="px-3 py-2.5 border-b border-[#c3d2f0] bg-white/90">
                    <%= if @show_new_expense do %>
                      <div class="flex items-center gap-2">
                        <input id="notebook-new-expense-input" type="text" autofocus
                          placeholder="coffee 4.75 or netflix 22.99 yesterday"
                          class="font-nunito flex-1 px-3 py-1.5 text-sm border-b-2 border-[#3f7fd6] bg-transparent focus:outline-none text-[#22335c] placeholder-[#a0b4d0]" />
                        <button id="notebook-new-expense-toggle-btn" phx-click="toggle_new_expense"
                          class="font-nunito font-bold flex-shrink-0 px-4 py-1.5 text-sm border-2 border-[#3f7fd6] rounded-full text-[#3f7fd6] hover:bg-[#3f7fd6]/10 transition-colors">
                          + New Expense
                        </button>
                      </div>
                    <% else %>
                      <div class="flex items-center gap-2">
                        <div class="relative">
                          ...
                          <input id="notebook-expense-search-input" type="text" placeholder="search..."
                            class="font-nunito pl-7 pr-3 py-1.5 text-sm border-2 border-[#c3d2f0] rounded-full bg-white focus:outline-none focus:border-[#3f7fd6] text-[#22335c] placeholder-[#a0b4d0] w-44 transition-colors" />
                        </div>
                        <button class="font-nunito flex items-center gap-1 px-2.5 py-1.5 text-sm font-semibold text-[#3f7fd6] hover:bg-[#3f7fd6]/10 rounded-full transition-colors">
                          Tags <.icon name="hero-chevron-down" class="w-3 h-3 mt-px" />
                        </button>
                        <button class="font-nunito flex items-center gap-1 px-2.5 py-1.5 text-sm font-semibold text-[#3f7fd6] hover:bg-[#3f7fd6]/10 rounded-full transition-colors">
                          ↕ Newest <.icon name="hero-chevron-down" class="w-3 h-3 mt-px" />
                        ...
                        <div class="flex-1"></div>
                        <button id="notebook-expense-new-btn" phx-click="toggle_new_expense"
                          class="font-nunito font-bold flex-shrink-0 px-4 py-1.5 text-sm bg-[#3f7fd6] hover:bg-[#2d6bc4] text-white rounded-full transition-colors shadow-sm shadow-[#3f7fd6]/30">
                          + New Expense
                        </button>
                      </div>
                    <% end %>
                  ...
                  <%!-- Expense Rows --%>
                  <%= for expense <- @expenses do %>
                    <div id={"notebook-expense-row-#{expense.id}"} phx-click="select_expense" phx-value-id={expense.id}
                      class="flex items-center gap-4 px-4 py-3 border-b border-[#c3d2f0]/60 hover:bg-[#3f7fd6]/5 transition-colors cursor-pointer">
                      <span class="flex-shrink-0 font-nunito text-sm text-[#6980b0] tabular-nums w-24">{expense.date}</span>
                      <span class="flex-1 font-nunito text-sm font-medium text-[#22335c]">{expense.description}</span>
                      <div class="flex items-center gap-1.5">
                        <%= for tag <- expense.tags do %>
                          <span class="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-xs font-semibold font-nunito bg-white border border-[#c3d2f0] text-[#22335c]">
                            <span class="w-2 h-2 rounded-full flex-shrink-0" style={"background: #{nb_tag_swatch(tag.label)}"}></span>
                            {tag.label}
                          </span>
                        <% end %>
                      </div>
                      <span class="flex-shrink-0 font-nunito text-sm font-bold text-[#3f9d6c] tabular-nums w-16 text-right">{expense.amount}</span>
                    </div>
                  <% end %>
                  ...
                  <div id="notebook-expense-edit-panel" class="absolute inset-0 flex">
                    ...
                    <div class="nb-denim w-80 border-l border-[#0d1a35] flex flex-col shadow-2xl">
                      <div class="flex items-start justify-between px-6 pt-5 pb-2">
                        <div>
                          <p class="font-caveat text-2xl text-white font-semibold leading-tight">Edit Expense</p>
                          <p class="font-nunito text-xs text-[#6ca0ea] mt-0.5">June · Groceries</p>
                        </div>
                        <button phx-click="close_expense" class="text-[#6ca0ea] hover:text-white transition-colors mt-0.5">
                          <.icon name="hero-x-mark" class="w-6 h-6" />
                        </button>
                      </div>
                      <div class="px-5 pb-4 flex-1 space-y-3 overflow-y-auto">
                        <div class="bg-white/10 rounded-lg px-4 py-3">
                          <label class="font-nunito text-xs font-semibold text-[#6ca0ea] uppercase tracking-wide block mb-1">Date</label>
                          <input type="date" value={to_date_input(@selected_expense.date)}
                        ...
                        <div class="bg-white/10 rounded-lg px-4 py-3">
                          <label class="font-nunito text-xs font-semibold text-[#6ca0ea] uppercase tracking-wide block mb-1">Description</label>
                          <input type="text" value={@selected_expense.description}
                            class="font-nunito w-full text-sm bg-transparent border-b border-[#6ca0ea]/50 text-white focus:outline-none focus:border-[#6ca0ea] pb-1 transition-colors" />
                        </div>
                        <div class="bg-white/10 rounded-lg px-4 py-3">
                          <label class="font-nunito text-xs font-semibold text-[#6ca0ea] uppercase tracking-wide block mb-1">Cost</label>
                          <input type="text" value={@selected_expense.amount}
                            class="font-nunito w-full text-sm bg-transparent border-b border-[#6ca0ea]/50 text-white focus:outline-none focus:border-[#6ca0ea] pb-1 transition-colors" />
                        </div>
                        <div>
                          <label class="font-nunito text-xs font-semibold text-[#6ca0ea] uppercase tracking-wide block mb-2 px-1">Tags</label>
                          <div class="space-y-1.5">
                            <%= for tag <- @available_tags do %>
                              <label class="flex items-center gap-2.5 cursor-pointer bg-white/10 hover:bg-white/20 rounded-lg px-3 py-2 transition-colors">
                                ...
                                <span class="w-2.5 h-2.5 rounded-full flex-shrink-0" style={"background: #{nb_tag_swatch(tag.label)}"}></span>
                      ...
                      <div class="flex items-center justify-between px-6 py-4 border-t border-white/10">
                        <button class="font-nunito text-sm font-bold text-[#e0796e] hover:text-[#f0958b] transition-colors">Delete</button>
                        <button class="font-nunito font-bold px-5 py-2 text-sm text-white bg-[#3f9d6c] hover:bg-[#34875b] rounded-full transition-colors shadow-sm">Save</button>
                      </div>
                    </div>
                  </div>
                <% end %>
