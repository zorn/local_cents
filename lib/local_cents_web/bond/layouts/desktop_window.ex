defmodule LocalCentsWeb.Bond.Layouts.DesktopWindow do
  ...
  def desktop_window(assigns) do
    ...
    <div
      ...
      style="border: 1px solid var(--color-border); box-shadow: 0 10px 15px -3px color-mix(in srgb, var(--color-accent) 20%, transparent); --nb-t: var(--color-accent); --nb-t-dk: var(--color-accent-dark); background-color: var(--color-surface-sunken); background-image: repeating-linear-gradient(45deg, rgba(255,255,255,0.30) 0px, rgba(255,255,255,0.30) 1px, transparent 1px, transparent 5px)"
    >
      <div
        class="relative flex items-center pl-3 pr-4 py-2 select-none"
        style="border-bottom: 1px solid var(--color-title-bar-border); background-color: var(--color-title-bar-background); background-image: radial-gradient(ellipse at 18% 32%, rgba(63,127,214,0.28) 0%, transparent 52%), radial-gradient(ellipse at 78% 72%, rgba(20,35,75,0.65) 0%, transparent 44%), radial-gradient(ellipse at 50% 5%, rgba(34,51,92,0.35) 0%, transparent 58%)"
      >
