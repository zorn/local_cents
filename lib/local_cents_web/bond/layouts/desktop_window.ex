defmodule LocalCentsWeb.Bond.Layouts.DesktopWindow do
  ...
  def desktop_window(assigns) do
    ...
    <div
      ...
      style="border: 1px solid var(--color-surface-400); box-shadow: 0 10px 15px -3px color-mix(in srgb, var(--color-primary-800) 20%, transparent); --bond-ink: var(--color-primary-800)"
    >
